...
//console.log(this.i,"iiiiiiiiii")
  ...
  LuShu.prototype.getMarker = function () {
	return this._marker
  }
  //Lushu私有方法
  baidu.object.extend(LuShu.prototype, {
	...
	_move: function (initPos, targetPos, effect) {
	  ...
	  //总的步长
		  count = 10// Math.round(me._getDistance(init_pos, target_pos) /step);
	  //如果小于1直接移动到下一点
	  if (count < 1) {
		me._moveNext(++me.i);
		return;
	...
	setRotation: function (prePos, curPos, targetPos) {
	  ...
	  var me = this;
	  me._marker.setRotation(me._opts.DirectionArr[me.i]);
	  return;
	  var deg = 0;
	...
	_moveNext: function (index) {
	  ...
	  if (index < this._path.length - 1) {
		...
		//me._move(me._path[index], me._path[index + 1], me._opts.DirectionArr[index]);
	  }
	},
